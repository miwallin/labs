...
function App() {
  ...
  const [books, markBook] = useState([
    ...
    {"title": "One Hundred Years of Solitude", "author": "García Márquez, Gabriel", "year_written": 1967, "edition": "Harper  Perennial", "price":  14.00},
    {"title": "Hamlet, Prince of Denmark", "author": "Shakespeare, William", "year_written": 1603, "edition": "Signet  Classics", "price":  7.95},
    {"title": "Lord of the Rings", "author": "Tolkien, J.R.R.", "year_written": 1937, "edition": "Penguin", "price":  27.45}
  ]);
